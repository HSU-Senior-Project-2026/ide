...
//const AUTHENTICATED_EXTRA_CE_BASE_URL = "https://ce.judge0.com";
...
//const UNAUTHENTICATED_EXTRA_CE_BASE_URL = "https://ce.judge0.com";
...
function run() {
    ...
    let selectedLanguageName = $selectLanguage.find(":selected").text() || "";
    ...
    // Java needs more memory than the default sandbox limit on some local setups.
    if (languageId === 62 || selectedLanguageName.startsWith("Java")) {
        data.memory_limit = 512000;
    }
